...
class ChampionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create champion" do
    assert_difference('Champion.count') do
      post champions_url, params: { champion: { faction: @champion.faction, name: @champion.name, race: @champion.race } }
    end
  ...
  test "should update champion" do
    patch champion_url(@champion), params: { champion: { faction: @champion.faction, name: @champion.name, race: @champion.race } }
